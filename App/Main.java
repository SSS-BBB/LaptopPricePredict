...
public class Main {
    ...
    public static void startProgram() {
        ...
        windowHandler.addSelectedPage(0, "Brand", "Selct Brand", "Next", new String[]{ "Apple", "HP", "MSI", "MICROSOFT", "Dell", "Razer", "Asus", "Lenovo", "Acer", "Samsung" });
        windowHandler.addSelectedPage(1, "CPU", "Selct CPU", "Next", new String[]{ "Intel i3", "Intel i5", "Intel i7", "Intel i9", "AMD Ryzen 3", "AMD Ryzen 5", "AMD Ryzen 7", "AMD Ryzen 9"});
        windowHandler.addSelectedPage(2, "RAM", "Enter RAM (GB)", "Next", "");
        windowHandler.addSelectedPage(3, "Storage", "Selct Storage", "Next", new String[]{ "512GB SSD", "2TB SSD", "256GB SSD", "1TB SSD", "1TB HDD" });
        windowHandler.addSelectedPage(4, "GPU", "Selct GPU", "Next", new String[]{ "Nvidia RTX 2060", "Nvidia GTX 1650", "Nvidia RTX 3060", "Nvidia RTX 3080", "AMD Radeon RX 6600", "AMD Radeon RX 6800", "Integrated" });
        windowHandler.addSelectedPage(5, "Screen Size", "Enter Screen Size (inch)", "Next", "");
        windowHandler.addSelectedPage(6, "Resolution", "Selct Resolution", "Next", new String[]{ "3840x2160", "1366x768", "1920x1080", "2560x1440" });
        windowHandler.addSelectedPage(7, "Battery Life", "Enter Battery Life (hours)", "Next", "");
        windowHandler.addSelectedPage(8, "Weight", "Enter Weight (kg)", "Next", "");
